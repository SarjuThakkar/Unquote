    ...
    <main class="isolate">
      ...
      <div class="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div v-if="userId === null" class="px-4 sm:px-6 lg:px-8 mx-auto py-8 sm:py-12 lg:py-14">
          <p class="mt-6 text-lg leading-8 text-gray-600">You must be signed in to view your bookmarks.</p>
        </div>
        <div v-else class="px-4 sm:px-6 lg:px-8 mx-auto py-8 sm:py-12 lg:py-14">
          <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
              <h1 class="text-base font-semibold leading-6 text-gray-900">Bookmarks</h1>
            </div>
          </div>
          <div class="-mx-4 mt-10 ring-1 ring-gray-300 sm:mx-0 sm:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300">
              ...
              <tbody>
                <tr v-for="(quote, quoteIdx) in bookmarkedQuotes" :key="quote.quoteId">
                  <td
...
export default {
  computed: {
    ...mapState(['userId', 'bookmarkedQuotes']),
  }
};
</script>
